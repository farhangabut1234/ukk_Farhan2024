...
?>
    <form action="aksi_hapusfoto.php" method="POST">
        <input type="number" id="Fotoid" name="Fotoid" value="<?php echo $data['foto_id'] ?>" hidden>

        <div class="row"><label for="">Title :</label></div>
        <div class="row"><input type="text" id="Nama_album" name="Nama_album" value="<?php echo $data['judul_foto'] ?>"></div>
        <br>
        ...
        <div class="row"><input type="date" id="Tanggal_unggah" name="Tanggal_unggah" value="<?php echo $data['tanggal_unggah'] ?>"></div>
        <br>

        <div class="row"><label for="">File Location :</label></div>
        <div class="row"><input type="date" id="Lokasi_file" name="Terakhir_edit" value="<?php echo $data['lokasi_file'] ?>"></div>
        <br>
