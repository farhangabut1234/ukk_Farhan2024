...
?>
    <form action="aksi_hapusalbum.php" method="POST">
        <input type="number" id="Albumid" name="Albumid" value="<?php echo $data['album_id'] ?>" hidden>

        <div class="row"><label for="">Album Name :</label></div>
        <div class="row"><input type="text" id="Nama_album" name="Nama_album" value="<?php echo $data['nama_album'] ?>"></div>
        <br>

        <div class="row"><label for="">Description :</label></div>
        <div class="row"><input type="text" id="Deskripsi" name="Deskripsi" value="<?php echo $data['deskripsi'] ?>"></div>
        <br>

        <div class="row"><label for="">Upload at :</label></div>
        <div class="row"><input type="date" id="Tanggal_dibuat" name="Tanggal_dibuat" value="<?php echo $data['tanggal_dibuat'] ?>"></div>
        <br>

        <div class="row"><label for="">Last Upload at :</label></div>
        <div class="row"><input type="date" id="Terakhir_edit" name="Terakhir_edit" value="<?php echo $data['terakhir_edit'] ?>"></div>
        <br>

        <button class="btn" type="submit" name="edit">Delete Data</button>

        <br><br>
        <p><a href="beranda_album.php"><-- back</a></p>
    </form>
<?php } ?>
