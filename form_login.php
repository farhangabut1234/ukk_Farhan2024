...
<header class="header">
    ...
    <div class="navbar">
        ...
        <a href="#"><li style="box-shadow: slategrey 0px 0px 10px 0px; width: 100px; text-align: center;">Login</li></a>
        <a href="form_register.php"><li>Register</li></a>
    </div>
...
<div class="container">
    ...
    <form action="aksi_login.php" method="POST">
        ...
        <div class="row"><input type="text" id="Username" name="Username" placeholder="input username ..."></div>

        <br>

        <div class="row"><label for="">Password :</label></div>
        <div class="row"><input type="text" id="Password" name="Password" placeholder="input password ..."></div>
        <br>
        <button class="btn" type="submit" name="kirim">Login</button>

        <br><br>
        <p>Do you not have account ?<a href="form_register.php"> Click here</a></p>
        <br>
        <p><a href="index.php"><-- back</a></p>
        <br>
        <p><a href="form_register.php">next to register --></a></p>
    </form>
